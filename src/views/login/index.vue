          ...
          <el-form-item>
            <div>
              <img src="@/assets/images/logo.png" style="
                    ...
                    user-drag: none;
                " />
              <span class="loginTitle">社区共享图书信息系统</span>
            </div>
          </el-form-item>
      ...
      <div slot="content">
        <el-form ref="addRef" :model="addModel" :rules="registeRules" label-width="80px" style="margin-right: 30px">
          ...
          <el-row>
            ...
            <el-col :span="12" :offset="0">
              <el-form-item prop="className" label="家庭住址">
  ...
  data() {
    return {
      registeRules: {
        ...
        username: [{ required: true, message: '请填写社区号码', trigger: 'blur' }],
        idCard: [
        ...
        className: [{ required: true, message: '请填写家庭住址', trigger: 'blur' }]
      },
      // 表单属性
      addModel: {
        type: '',
